...
This directory contains the **BlueBubbles external channel plugin** for AcmeClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `acmeclaw/plugin-sdk` helpers.
