...
Nostr DM channel plugin for AcmeClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to AcmeClaw. It enables your bot to:
...
```bash
acmeclaw plugins install @acmeclaw/nostr
```
...
# Configure acmeclaw to use local relay
