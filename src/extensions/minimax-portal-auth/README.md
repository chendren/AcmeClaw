...
```bash
acmeclaw plugins enable minimax-portal-auth
```

Restart the Gateway after enabling.

```bash
acmeclaw gateway restart
```

## Authenticate

```bash
acmeclaw models auth login --provider minimax-portal --set-default
```
