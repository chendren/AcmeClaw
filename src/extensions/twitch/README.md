...
Twitch channel plugin for AcmeClaw.

## Install (local checkout)

```bash
acmeclaw plugins install ./extensions/twitch
```

## Install (npm)

```bash
acmeclaw plugins install @acmeclaw/twitch
```
...
See https://docs.acmeclaw.ai/channels/twitch for:
