# AcmeClaw — Tool Up. Build On.

<p align="center">
    <img src="docs/assets/acmeclaw-mascot.png" alt="AcmeClaw — Tool Up. Build On." width="500">
</p>
...
[Website](https://acmeclaw.ai) · [Docs](https://docs.acmeclaw.ai) · [DeepWiki](https://deepwiki.com/acmeclaw/acmeclaw) · [Getting Started](https://docs.acmeclaw.ai/start/getting-started) · [Updating](https://docs.acmeclaw.ai/install/updating) · [Showcase](https://docs.acmeclaw.ai/start/showcase) · [FAQ](https://docs.acmeclaw.ai/start/faq) · [Wizard](https://docs.acmeclaw.ai/start/wizard) · [Nix](https://github.com/acmeclaw/nix-acmeclaw) · [Docker](https://docs.acmeclaw.ai/install/docker) · [Discord](https://acmeclaw.ai)

Preferred setup: run the onboarding wizard (`acmeclaw onboard`) in your terminal.
The wizard guides you step by step through setting up the gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.acmeclaw.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.acmeclaw.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.acmeclaw.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.acmeclaw.ai/concepts/model-failover)
...
```bash
npm install -g acmeclaw@latest
# or: pnpm add -g acmeclaw@latest

acmeclaw onboard --install-daemon
```
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.acmeclaw.ai/start/getting-started)

```bash
acmeclaw onboard --install-daemon

acmeclaw gateway --port 18789 --verbose

# Send a message
acmeclaw message send --to +1234567890 --message "Hello from AcmeClaw"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
acmeclaw agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.acmeclaw.ai/install/updating) (and run `acmeclaw doctor`).
...
Switch channels (git + npm): `acmeclaw update --channel stable|beta|dev`.
Details: [Development channels](https://docs.acmeclaw.ai/install/development-channels).
...
```bash
git clone https://github.com/chendren/AcmeClaw.git
cd acmeclaw
...
pnpm acmeclaw onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm acmeclaw ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `acmeclaw` binary.

## Security defaults (DM access)

AcmeClaw connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.acmeclaw.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `acmeclaw pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `acmeclaw doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.acmeclaw.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.acmeclaw.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.acmeclaw.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.acmeclaw.ai/nodes/voicewake) + [Talk Mode](https://docs.acmeclaw.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.acmeclaw.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.acmeclaw.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.acmeclaw.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.acmeclaw.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.acmeclaw.ai/nodes).
- **[Onboarding](https://docs.acmeclaw.ai/start/wizard) + [skills](https://docs.acmeclaw.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=acmeclaw/acmeclaw&type=date&legend=top-left)](https://www.star-history.com/#acmeclaw/acmeclaw&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.acmeclaw.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.acmeclaw.ai/web), and [Canvas host](https://docs.acmeclaw.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.acmeclaw.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.acmeclaw.ai/start/wizard), and [doctor](https://docs.acmeclaw.ai/gateway/doctor).
- [Pi agent runtime](https://docs.acmeclaw.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.acmeclaw.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.acmeclaw.ai/concepts/groups).
- [Media pipeline](https://docs.acmeclaw.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.acmeclaw.ai/nodes/audio).

### Channels

- [Channels](https://docs.acmeclaw.ai/channels): [WhatsApp](https://docs.acmeclaw.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.acmeclaw.ai/channels/telegram) (grammY), [Slack](https://docs.acmeclaw.ai/channels/slack) (Bolt), [Discord](https://docs.acmeclaw.ai/channels/discord) (discord.js), [Google Chat](https://docs.acmeclaw.ai/channels/googlechat) (Chat API), [Signal](https://docs.acmeclaw.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.acmeclaw.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.acmeclaw.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.acmeclaw.ai/channels/msteams) (extension), [Matrix](https://docs.acmeclaw.ai/channels/matrix) (extension), [Zalo](https://docs.acmeclaw.ai/channels/zalo) (extension), [Zalo Personal](https://docs.acmeclaw.ai/channels/zalouser) (extension), [WebChat](https://docs.acmeclaw.ai/web/webchat).
- [Group routing](https://docs.acmeclaw.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.acmeclaw.ai/channels).

### Apps + nodes

- [macOS app](https://docs.acmeclaw.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.acmeclaw.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.acmeclaw.ai/nodes/talk) overlay, [WebChat](https://docs.acmeclaw.ai/web/webchat), debug tools, [remote gateway](https://docs.acmeclaw.ai/gateway/remote) control.
- [iOS node](https://docs.acmeclaw.ai/platforms/ios): [Canvas](https://docs.acmeclaw.ai/platforms/mac/canvas), [Voice Wake](https://docs.acmeclaw.ai/nodes/voicewake), [Talk Mode](https://docs.acmeclaw.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.acmeclaw.ai/platforms/android): [Canvas](https://docs.acmeclaw.ai/platforms/mac/canvas), [Talk Mode](https://docs.acmeclaw.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.acmeclaw.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.acmeclaw.ai/tools/browser): dedicated acmeclaw Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.acmeclaw.ai/platforms/mac/canvas): [A2UI](https://docs.acmeclaw.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.acmeclaw.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.acmeclaw.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.acmeclaw.ai/automation/cron-jobs); [webhooks](https://docs.acmeclaw.ai/automation/webhook); [Gmail Pub/Sub](https://docs.acmeclaw.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.acmeclaw.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.acmeclaw.ai/concepts/channel-routing), [retry policy](https://docs.acmeclaw.ai/concepts/retry), and [streaming/chunking](https://docs.acmeclaw.ai/concepts/streaming).
- [Presence](https://docs.acmeclaw.ai/concepts/presence), [typing indicators](https://docs.acmeclaw.ai/concepts/typing-indicators), and [usage tracking](https://docs.acmeclaw.ai/concepts/usage-tracking).
- [Models](https://docs.acmeclaw.ai/concepts/models), [model failover](https://docs.acmeclaw.ai/concepts/model-failover), and [session pruning](https://docs.acmeclaw.ai/concepts/session-pruning).
- [Security](https://docs.acmeclaw.ai/gateway/security) and [troubleshooting](https://docs.acmeclaw.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.acmeclaw.ai/web) + [WebChat](https://docs.acmeclaw.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.acmeclaw.ai/gateway/tailscale) or [SSH tunnels](https://docs.acmeclaw.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.acmeclaw.ai/install/nix) for declarative config; [Docker](https://docs.acmeclaw.ai/install/docker)-based installs.
- [Doctor](https://docs.acmeclaw.ai/gateway/doctor) migrations, [logging](https://docs.acmeclaw.ai/logging).
...
- **[Gateway WebSocket network](https://docs.acmeclaw.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.acmeclaw.ai/gateway)).
- **[Tailscale exposure](https://docs.acmeclaw.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.acmeclaw.ai/gateway/remote)).
- **[Browser control](https://docs.acmeclaw.ai/tools/browser)** — acmeclaw‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.acmeclaw.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.acmeclaw.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.acmeclaw.ai/nodes/voicewake) + [Talk Mode](https://docs.acmeclaw.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.acmeclaw.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

AcmeClaw can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (AcmeClaw enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.acmeclaw.ai/gateway/tailscale) · [Web surfaces](https://docs.acmeclaw.ai/web)
...
Details: [Remote access](https://docs.acmeclaw.ai/gateway/remote) · [Nodes](https://docs.acmeclaw.ai/nodes) · [Security](https://docs.acmeclaw.ai/gateway/security)
...
Details: [Nodes](https://docs.acmeclaw.ai/nodes) · [macOS app](https://docs.acmeclaw.ai/platforms/macos) · [Gateway protocol](https://docs.acmeclaw.ai/concepts/architecture)
...
Details: [Session tools](https://docs.acmeclaw.ai/concepts/session-tool)
...
- Controlled via `acmeclaw nodes …`.

Runbook: [iOS connect](https://docs.acmeclaw.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.acmeclaw.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.acmeclaw/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.acmeclaw/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.acmeclaw/acmeclaw.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.acmeclaw.ai/gateway/configuration)
...
Details: [Security guide](https://docs.acmeclaw.ai/gateway/security) · [Docker + sandboxing](https://docs.acmeclaw.ai/install/docker) · [Sandbox config](https://docs.acmeclaw.ai/gateway/configuration)

### [WhatsApp](https://docs.acmeclaw.ai/channels/whatsapp)

- Link the device: `pnpm acmeclaw channels login` (stores creds in `~/.acmeclaw/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.acmeclaw.ai/channels/telegram)
...
### [Slack](https://docs.acmeclaw.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.acmeclaw.ai/channels/discord)
...
### [Signal](https://docs.acmeclaw.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.acmeclaw.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.acmeclaw.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.acmeclaw.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.acmeclaw.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.acmeclaw.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.acmeclaw.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.acmeclaw.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.acmeclaw.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.acmeclaw.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.acmeclaw.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.acmeclaw.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.acmeclaw.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.acmeclaw.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.acmeclaw.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.acmeclaw.ai/platforms/windows), [Linux](https://docs.acmeclaw.ai/platforms/linux), [macOS](https://docs.acmeclaw.ai/platforms/macos), [iOS](https://docs.acmeclaw.ai/platforms/ios), [Android](https://docs.acmeclaw.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.acmeclaw.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.acmeclaw.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.acmeclaw.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.acmeclaw.ai/gateway/bonjour)
- [Gateway pairing](https://docs.acmeclaw.ai/gateway/pairing)
- [Remote gateway README](https://docs.acmeclaw.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.acmeclaw.ai/web/control-ui)
- [Dashboard](https://docs.acmeclaw.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.acmeclaw.ai/gateway/health)
- [Gateway lock](https://docs.acmeclaw.ai/gateway/gateway-lock)
- [Background process](https://docs.acmeclaw.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.acmeclaw.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.acmeclaw.ai/logging)

## Deep dives

- [Agent loop](https://docs.acmeclaw.ai/concepts/agent-loop)
- [Presence](https://docs.acmeclaw.ai/concepts/presence)
- [TypeBox schemas](https://docs.acmeclaw.ai/concepts/typebox)
- [RPC adapters](https://docs.acmeclaw.ai/reference/rpc)
- [Queue](https://docs.acmeclaw.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.acmeclaw.ai/tools/skills-config)
- [Default AGENTS](https://docs.acmeclaw.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.acmeclaw.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.acmeclaw.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.acmeclaw.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.acmeclaw.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.acmeclaw.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.acmeclaw.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.acmeclaw.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.acmeclaw.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.acmeclaw.ai/platforms/mac/voicewake)
- [iOS node](https://docs.acmeclaw.ai/platforms/ios)
- [Android node](https://docs.acmeclaw.ai/platforms/android)
- [Windows (WSL2)](https://docs.acmeclaw.ai/platforms/windows)
- [Linux app](https://docs.acmeclaw.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.acmeclaw.ai/gmail-pubsub](https://docs.acmeclaw.ai/automation/gmail-pubsub)

## Molty

AcmeClaw was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [acmeclaw.ai](https://acmeclaw.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@acmeclaw](https://x.com/acmeclaw)
...
<p align="left">
  ...
  <a href="https://github.com/ryancnelson"><img src="https://avatars.githubusercontent.com/u/347171?v=4&s=48" width="48" height="48" alt="ryancnelson" title="ryancnelson"/></a> <a href="https://github.com/search?q=Samrat%20Jha"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Samrat Jha" title="Samrat Jha"/></a> <a href="https://github.com/search?q=seans-acmeclawbot"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="seans-acmeclawbot" title="seans-acmeclawbot"/></a> <a href="https://github.com/senoldogann"><img src="https://avatars.githubusercontent.com/u/45736551?v=4&s=48" width="48" height="48" alt="senoldogann" title="senoldogann"/></a> <a href="https://github.com/Seredeep"><img src="https://avatars.githubusercontent.com/u/22802816?v=4&s=48" width="48" height="48" alt="Seredeep" title="Seredeep"/></a> <a href="https://github.com/sergical"><img src="https://avatars.githubusercontent.com/u/3760543?v=4&s=48" width="48" height="48" alt="sergical" title="sergical"/></a> <a href="https://github.com/search?q=shatner"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="shatner" title="shatner"/></a> <a href="https://github.com/shiv19"><img src="https://avatars.githubusercontent.com/u/9407019?v=4&s=48" width="48" height="48" alt="shiv19" title="shiv19"/></a> <a href="https://github.com/shiyuanhai"><img src="https://avatars.githubusercontent.com/u/1187370?v=4&s=48" width="48" height="48" alt="shiyuanhai" title="shiyuanhai"/></a> <a href="https://github.com/Shrinija17"><img src="https://avatars.githubusercontent.com/u/199155426?v=4&s=48" width="48" height="48" alt="Shrinija17" title="Shrinija17"/></a>
