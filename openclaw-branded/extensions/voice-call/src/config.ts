 ...
 * - "manual": Stay open without auto-response so an external controller can
 *   explicitly wait, speak, and send DTMF step by step
 */
export const CallModeSchema = z.enum(["notify", "conversation", "manual"]);
