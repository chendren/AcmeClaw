...
*/
const _g = globalThis;
const handlers = _g.__acmeclaw_internal_hook_handlers__ ??= /* @__PURE__ */ new Map();
...
function resolveAcmeClawManifestBlock(params) {
...
function resolveAcmeClawManifestRequires(metadataObj) {
...
function resolveAcmeClawManifestInstall(metadataObj, parseInstallSpec) {
	return (Array.isArray(metadataObj.install) ? metadataObj.install : []).map((entry) => parseInstallSpec(entry)).filter((entry) => Boolean(entry));
}
function resolveAcmeClawManifestOs(metadataObj) {
	return normalizeStringList(metadataObj.os);
}
function parseAcmeClawManifestInstallBase(input, allowedKinds) {
...
function applyAcmeClawManifestInstallCommonFields(spec, parsed) {
...
//#endregion
export { isGatewayStartupEvent as _, parseAcmeClawManifestInstallBase as a, resolveAcmeClawManifestOs as c, evaluateRuntimeEligibility as d, hasBinary as f, isAgentBootstrapEvent as g, createInternalHookEvent as h, parseFrontmatterBool as i, resolveAcmeClawManifestRequires as l, MANIFEST_KEY as m, getFrontmatterString as n, resolveAcmeClawManifestBlock as o, isConfigPathTruthyWithDefaults as p, normalizeStringList as r, resolveAcmeClawManifestInstall as s, applyAcmeClawManifestInstallCommonFields as t, parseFrontmatterBlock as u, registerInternalHook as v, triggerInternalHook as y };
