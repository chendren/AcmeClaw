...
${formatHelpExamples([
		["acmeclaw message send --target +15555550123 --message \"Hi\"", "Send a text message."],
		["acmeclaw message send --target +15555550123 --message \"Hi\" --media photo.jpg", "Send a message with media."],
		["acmeclaw message poll --channel discord --target channel:123 --poll-question \"Snack?\" --poll-option Pizza --poll-option Sushi", "Create a Discord poll."],
		["acmeclaw message react --channel discord --target 123 --message-id 456 --emoji \"✅\"", "React to a message."]
	])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.acmeclaw.ai/cli/message")}`).action(() => {
