...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("acmeclaw.contextEngineRegistryState");
...
const REGISTRY_STATE = Symbol.for("acmeclaw.pluginRegistryState");
const state = (() => {
	const globalState = globalThis;
...
const CHAT_CHANNEL_META = {
	telegram: {
		...
		selectionExtras: ["https://acmeclaw.ai"]
	},
	whatsapp: {
		id: "whatsapp",
		label: "WhatsApp",
