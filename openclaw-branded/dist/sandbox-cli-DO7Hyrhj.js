...
const SANDBOX_DOCS_URL = "https://docs.acmeclaw.ai/sandbox";
...
async function sandboxExplainCommand(opts, runtime) {
	...
	lines.push("");
	lines.push(`${key("Docs:")} ${formatDocsLink("/sandbox", "docs.acmeclaw.ai/sandbox")}`);
...
function displaySummary(containers, browsers, runtime) {
	...
	if (mismatchCount > 0) {
		...
		runtime.log(`   Run '${formatCliCommand("acmeclaw sandbox recreate --all")}' to update all containers.`);
	}
}
...
const SANDBOX_EXAMPLES = {
	main: [
		["acmeclaw sandbox list", "List all sandbox containers."],
		["acmeclaw sandbox list --browser", "List only browser containers."],
		["acmeclaw sandbox recreate --all", "Recreate all containers."],
		["acmeclaw sandbox recreate --session main", "Recreate a specific session."],
		["acmeclaw sandbox recreate --agent mybot", "Recreate agent containers."],
		["acmeclaw sandbox explain", "Explain effective sandbox config."]
	],
	list: [
		["acmeclaw sandbox list", "List all sandbox containers."],
		["acmeclaw sandbox list --browser", "List only browser containers."],
		["acmeclaw sandbox list --json", "JSON output."]
	],
	recreate: [
		["acmeclaw sandbox recreate --all", "Recreate all containers."],
		["acmeclaw sandbox recreate --session main", "Recreate a specific session."],
		["acmeclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
		["acmeclaw sandbox recreate --browser --all", "Recreate only browser containers."],
		["acmeclaw sandbox recreate --all --force", "Skip confirmation."]
	],
	explain: [
		["acmeclaw sandbox explain", "Show effective sandbox config."],
		["acmeclaw sandbox explain --session agent:main:main", "Explain a specific session."],
		["acmeclaw sandbox explain --agent work", "Explain an agent sandbox."],
		["acmeclaw sandbox explain --json", "JSON output."]
	]
};
