...
import { A as normalizeProviderId, B as resolvePluginProviders, D as modelKey, Dt as openUrl, Ev as resolveAcmeClawAgentDir, Fv as DEFAULT_PROVIDER, P as resolveConfiguredModelRef, Pv as DEFAULT_MODEL, S as buildModelAliasIndex, _v as listProfilesForProvider, bv as ensureAuthProfileStore, ff as loadModelCatalog, gf as hasUsableCustomProviderApiKey, x as buildAllowedModelSet, yf as resolveEnvApiKey, yv as upsertAuthProfile } from "./reply-Bm8VrLQh.js";
...
async function runProviderPluginAuthMethod(params) {
	...
	const agentDir = params.agentDir ?? (agentId === defaultAgentId ? resolveAcmeClawAgentDir() : resolveAgentDir(params.config, agentId));
...
async function applyAuthChoicePluginProvider(params, options) {
	...
	const agentDir = params.agentDir ?? (agentId === defaultAgentId ? resolveAcmeClawAgentDir() : resolveAgentDir(nextConfig, agentId));
