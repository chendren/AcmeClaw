    ...
    <svg viewBox="0 0 120 120" fill="none">
      <defs>
        <linearGradient id="lob-g" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stop-color="#dc3c32" />
          <stop offset="100%" stop-color="#8b1a1a" />
        </linearGradient>
      </defs>
      <rect x="30" y="30" width="60" height="50" rx="12" fill="url(#lob-g)" />
      <rect x="35" y="15" width="50" height="35" rx="10" fill="url(#lob-g)" />
      <line x1="50" y1="15" x2="40" y2="5" stroke="#dc3c32" stroke-width="3" stroke-linecap="round" />
      <circle cx="40" cy="5" r="3" fill="#dc3c32" />
      <line x1="70" y1="15" x2="80" y2="5" stroke="#dc3c32" stroke-width="3" stroke-linecap="round" />
      <circle cx="80" cy="5" r="3" fill="#dc3c32" />
      <circle cx="48" cy="32" r="6" fill="#050810" />
      <circle cx="72" cy="32" r="6" fill="#050810" />
      <circle cx="49" cy="31" r="3" fill="#00e5cc" />
      <circle cx="73" cy="31" r="3" fill="#00e5cc" />
      <path d="M30 55L15 60L10 55L5 62L15 65L30 60Z" fill="url(#lob-g)" />
      <path d="M90 55L105 60L110 55L115 62L105 65L90 60Z" fill="url(#lob-g)" />
      <rect x="42" y="80" width="8" height="20" rx="3" fill="url(#lob-g)" />
      <rect x="70" y="80" width="8" height="20" rx="3" fill="url(#lob-g)" />
      <rect x="45" y="45" width="30" height="20" rx="4" fill="#0a0e17" opacity="0.5" />
      <rect x="50" y="50" width="20" height="3" rx="1" fill="#00e5cc" opacity="0.6" />
      <rect x="50" y="56" width="14" height="3" rx="1" fill="#00e5cc" opacity="0.4" />
    </svg>
  `,refresh:n`
    <svg viewBox="0 0 24 24">
...
`)}var Wd=`acmeclaw:skipDeleteConfirm`;function Gd(){try{return localStorage.getItem(Wd)===`1`}catch{return!1}}function Kd(e,t){return n`
  ...
  `}function Lf(){Y.slashMenuMode=`command`,Y.slashMenuCommand=null,Y.slashMenuArgItems=[],Y.slashMenuItems=[]}function Rf(e,t){let n=e.match(/^\/(\S+)\s(.*)$/);if(n){let e=n[1].toLowerCase(),r=n[2].toLowerCase(),i=uf.find(t=>t.name===e);if(i?.argOptions?.length){let e=r?i.argOptions.filter(e=>e.toLowerCase().startsWith(r)):i.argOptions;if(e.length>0){Y.slashMenuMode=`args`,Y.slashMenuCommand=i,Y.slashMenuArgItems=e,Y.slashMenuOpen=!0,Y.slashMenuIndex=0,Y.slashMenuItems=[],t();return}}Y.slashMenuOpen=!1,Lf(),t();return}let r=e.match(/^\/(\S*)$/);if(r){let e=pf(r[1]);Y.slashMenuItems=e,Y.slashMenuOpen=e.length>0,Y.slashMenuIndex=0,Y.slashMenuMode=`command`,Y.slashMenuCommand=null,Y.slashMenuArgItems=[]}else Y.slashMenuOpen=!1,Lf();t()}function zf(e,t,n){if(e.argOptions?.length){t.onDraftChange(`/${e.name} `),Y.slashMenuMode=`args`,Y.slashMenuCommand=e,Y.slashMenuArgItems=e.argOptions,Y.slashMenuOpen=!0,Y.slashMenuIndex=0,Y.slashMenuItems=[],n();return}Y.slashMenuOpen=!1,Lf(),e.executeLocal&&!e.args?(t.onDraftChange(`/${e.name}`),n(),t.onSend()):(t.onDraftChange(`/${e.name} `),n())}function Bf(e,t,n){if(e.argOptions?.length){t.onDraftChange(`/${e.name} `),Y.slashMenuMode=`args`,Y.slashMenuCommand=e,Y.slashMenuArgItems=e.argOptions,Y.slashMenuOpen=!0,Y.slashMenuIndex=0,Y.slashMenuItems=[],n();return}Y.slashMenuOpen=!1,Lf(),t.onDraftChange(e.args?`/${e.name} `:`/${e.name}`),n()}function Vf(e,t,n,r){let i=Y.slashMenuCommand?.name??``;Y.slashMenuOpen=!1,Lf(),t.onDraftChange(`/${i} ${e}`),n(),r&&t.onSend()}function Hf(e){return e.length<100?null:`~${Math.ceil(e.length/4)} tokens`}function Uf(e){po(e.messages,e.assistantName)}var Wf=[`What can you do?`,`Summarize my recent sessions`,`Help me configure a channel`,`Check system health`];function Gf(e){let t=e.assistantName||`Assistant`,r=Bl({identity:{avatar:e.assistantAvatar??void 0,avatarUrl:e.assistantAvatarUrl??void 0}}),i=Vl(e.basePath??``);return n`
    <div class="agent-chat__welcome" style="--agent-color: var(--accent)">
      ...
      ${r?n`<img src=${r} alt=${t} style="width:56px; height:56px; border-radius:50%; object-fit:cover;" />`:n`<div class="agent-chat__avatar agent-chat__avatar--logo"><img src=${i} alt="AcmeClaw" /></div>`}
      <h2>${t}</h2>
            ...
            <div class="usage-export-popover">
              <div class="usage-export-list">
                <button
                  ...
                  @click=${()=>qg(`acmeclaw-usage-sessions-${M}.csv`,Xg(u),`text/csv`)}
                  ?disabled=${u.length===0}
                >
                  Sessions CSV
                </button>
                <button
                  class="usage-export-item"
                  @click=${()=>qg(`acmeclaw-usage-daily-${M}.csv`,Zg(O),`text/csv`)}
                  ?disabled=${O.length===0}
                >
                  Daily CSV
                </button>
                <button
                  class="usage-export-item"
                  @click=${()=>qg(`acmeclaw-usage-${M}.json`,JSON.stringify({totals:C,sessions:u,daily:O,aggregates:D},null,2),`application/json`)}
    ...
    <div class="login-gate">
      ...
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${t} alt="AcmeClaw" />
          <div class="login-gate__title">AcmeClaw</div>
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>${M(`overview.connection.step1`)}<code>acmeclaw gateway run</code></li>
            <li>${M(`overview.connection.step2`)}<code>acmeclaw dashboard --no-open</code></li>
            <li>${M(`overview.connection.step3`)}</li>
          </ol>
          <div class="login-gate__docs">
            <a
              class="session-link"
              href="https://docs.acmeclaw.ai/web/dashboard"
              target="_blank"
              rel="noreferrer"
  ...
  `}function tb(e){let t=e.hello?.snapshot,r=t?.uptimeMs?d(t.uptimeMs):M(`common.na`),a=e.hello?.policy?.tickIntervalMs,o=a?`${(a/1e3).toFixed(a%1e3==0?0:1)}s`:M(`common.na`),s=t?.authMode===`trusted-proxy`,c=Xy(e.connected,e.lastError,e.lastErrorCode)?n`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">acmeclaw devices list</span><br />
          <span class="mono">acmeclaw devices approve &lt;requestId&gt;</span>
        </div>
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.acmeclaw.ai/web/control-ui#device-pairing-first-connection"
            target=${fv}
            rel=${pv()}
    ...
    `:null,l=(()=>{let t=Zy({connected:e.connected,lastError:e.lastError,lastErrorCode:e.lastErrorCode,hasToken:!!e.settings.token.trim(),hasPassword:!!e.password.trim()});return t==null?null:t===`required`?n`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">acmeclaw dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">acmeclaw doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
      ...
      `:n`
      <div class="muted" style="margin-top: 8px">
        ${M(`overview.auth.failed`,{command:`acmeclaw dashboard --no-open`})}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.acmeclaw.ai/web/dashboard"
    ...
    `})(),u=e.connected||!e.lastError||!(typeof window<`u`)||window.isSecureContext||!Qy(e.connected,e.lastError,e.lastErrorCode)?null:n`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.acmeclaw.ai/gateway/tailscale"
            target=${fv}
            rel=${pv()}
          ...
          <a
            class="session-link"
            href="https://docs.acmeclaw.ai/web/control-ui#insecure-http"
            target=${fv}
            rel=${pv()}
        ...
        ${e.connected?i:n`
                <div class="login-gate__help" style="margin-top: 16px;">
                  ...
                  <ol class="login-gate__steps">
                    ...
                    <li>${M(`overview.connection.step2`)}<code>acmeclaw dashboard --no-open</code></li>
                    <li>${M(`overview.connection.step3`)}</li>
                    <li>${M(`overview.connection.step4`)}<code>acmeclaw doctor --generate-gateway-token</code></li>
                  </ol>
                  <div class="login-gate__docs">
          ...
          <div class="sidebar-shell">
            <div class="sidebar-shell__header">
              <div class="sidebar-brand">
                ${f?i:n`
                        <img class="sidebar-brand__logo" src="${Vl(_)}" alt="AcmeClaw" />
                        <span class="sidebar-brand__copy">
                          <span class="sidebar-brand__eyebrow">${M(`nav.control`)}</span>
                          <span class="sidebar-brand__title">AcmeClaw</span>
                        </span>
                      `}
              </div>
              <button
