...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAcmeClawModelsJson } = await import("./auth-profiles-DRjqKE3G.js").then((n) => n.wg);
